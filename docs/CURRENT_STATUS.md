...
| Motor-System | ✅ Funktioniert | v1.4, 38 Wörter, Layer-System aktiv, 3 GLB-Fallbacks |
...
|-------|-------|--------|-------|
| motor_vocabulary.json | v1.4 | v1.4 | ✅ |
...
*Aktualisiert von: Motor v1.4 Session 2026-02-26*
